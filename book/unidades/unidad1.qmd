# Creación de un servidor web con Docker y Nginx
...
3. Construye una imagen Docker a partir del Dockerfile con el comando docker `build -t my-nginx-image` ..
4. Crea y ejecuta un contenedor a partir de la imagen con el comando `docker run -it --rm -dp 8080:80 -v ${PWD}/web:/usr/share/nginx/html --name web my-nginx-image .`
